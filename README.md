...
Which genes are             Retrieved studies               Yes.
most linked to              mentioning APOE, CD33,
Alzheimer's disease?        and other genes. 

How/why does age play       Found info explaining           Yes.
a role in Alzheimer's       how APOE effects vary
disease?                    by age. 

What do the studies say     Retrieved studies on            Yes.
about the role of the       immune system and how
immune system in            it plays a role.
Alzheimer's?

How does APOE affect        Found papers on APOE-           Yes.
the chance of getting       related genetic risk. 
Alzheimer's?

What are some new           Showed new studies              Yes.
findings scientists         identifying new loci.
have discovered in 
recent years?
